...
namespace InfoPanel
{
    public sealed class TuringPanelCTask
    {
        private static volatile TuringPanelCTask? _instance;
        ...
        public static TuringPanelCTask Instance
        {
            get
            {
                ...
                lock (_lock)
                {
                    if (_instance == null)
                    {
                        _instance = new TuringPanelCTask();
                    }
                }
                return _instance;
            }
        ...
        private void DoWork(CancellationToken token)
        {
            ...
            try
            {
                screen = ScreenFactory.Create(ScreenType.RevisionC, ConfigModel.Instance.Settings.TuringPanelCPort);
            }
            catch (Exception e)
            {
            ...
            //SharedModel.Instance.TriggerSnackbarMessage("Found " + device.Descriptor.Product + ". Ensure your profile width & height matches.");
