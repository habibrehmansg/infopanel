...
namespace InfoPanel.Drawing
{
    internal abstract class MyGraphics: IDisposable
    {
        ...
        public abstract void DrawPath(SKPath path, SKColor color, int strokeWidth, SKColor? gradientColor = null, float gradientAngle = 90f, GradientType gradientType = GradientType.Linear);
        public abstract void DrawPath(MyPoint[] points, string color, int strokeWidth);
        public abstract void FillPath(SKPath path, SKColor color, SKColor? gradientColor = null, float gradientAngle = 90f, GradientType gradientType = GradientType.Linear);
