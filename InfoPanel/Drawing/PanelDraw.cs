                ...
                case GaugeDisplayItem gaugeDisplayItem:
                    {
                        ...
                        if (imageA != null)
                        {
                            ...
                            if (cachedA != null)
                            {
                                ...
                                g.DrawImage(cachedA, x, y, scaledWidth, scaledHeight, 0, 0, 0, cache, cacheHint, flipX: gaugeDisplayItem.FlipX);
                                ...
                                if (imageB != null && imageB != imageA && blend > 0f)
                                {
                                    ...
                                    if (cachedB != null)
                                    {
                                        g.DrawImage(cachedB, x, y, scaledWidth, scaledHeight, 0, 0, 0, cache, cacheHint, flipX: gaugeDisplayItem.FlipX, opacity: blend);
                                    }
                                }
                            }
                        }
