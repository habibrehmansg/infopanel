...
namespace InfoPanel.TuringPanel
{
    public static class TuringPanelModelDatabase
    {
        public static readonly Dictionary<TuringPanelModel, TuringPanelModelInfo> Models = new()
        {
            ...
            [TuringPanelModel.REV_13INCH_USB] = new TuringPanelModelInfo { Model = TuringPanelModel.REV_13INCH_USB, Name = "Shiny Snake G600 11.3\" (Turing 10.2\")", Width = 440, Height = 1920, VendorId = 0x0525, ProductId = 0xa4a7, IsUsbDevice = false, HasPerDeviceTargetFps = true },
        };
