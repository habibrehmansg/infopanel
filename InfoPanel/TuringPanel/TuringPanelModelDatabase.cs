...
namespace InfoPanel.TuringPanel
{
    public static class TuringPanelModelDatabase
    {
        public static readonly Dictionary<TuringPanelModel, TuringPanelModelInfo> Models = new()
        {
            ...
            [TuringPanelModel.REV_46INCH_USB] = new TuringPanelModelInfo { Model = TuringPanelModel.REV_46INCH_USB, Name = "Turing Smart Screen 4.6\"", Width = 320, Height = 960, VendorId = 0x1cbe, ProductId = 0x0046, IsUsbDevice = true },
